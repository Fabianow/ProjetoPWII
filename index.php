...
<body>
  <div id="home" class="background">
    ...
    <main>
      <div class="container">
        <div class="main-text">
          <h3>Sua loja de artigos oficiais</h3>
          <h1>TORCIDA STYLE</h1>
          <h2>Seu esporte, nosso estilo</h2>
          <div>
        ...
        <div class="main-img">
          <img src="img/jogador.png" alt="Modelo de Roupas">
        </div>
  ...
  <div class="product-grid">
    ...
    <div class="product-card">
      <img src="img/camiseta_flamengo1.jpg" alt="Camiseta Flamengo" class="product-image">
      <p class="badge flamengo">Flamengo</p>
